...
- <a href="https://github.com/MHSanaei/3x-ui" target="_blank">3X-UI 原版</a>
...
```
VERSION=v1.7.9 && <(curl -Ls "https://raw.githubusercontent.com/YSeverything/3x-ui-cn/$VERSION/install.sh") $VERSION
```
